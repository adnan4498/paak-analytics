...
const CoursePage = ({ params }) => {
    ...
    const excelData = [
      {
        ...
        Catetory: 'Artificial Intelligence', SubCategory: 'Ensemble Methods', 
  ...
  const subCategories = ['all', ...new Set(allCourses.map(course => course.subCategory))];
  ...
  useEffect(() => {
    applyFilters();
  }, [selectedRating, selectedLevel, priceRange, searchQuery, selectedCategory, selectedSubCategory]);
      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <p className="text-gray-600 text-lg">Browse our complete catalog of courses</p>
            <div className="mt-4 flex items-center space-x-4 text-sm text-gray-500">
              <span>{filteredCourses.length} courses</span>
              <span>•</span>
              <span>Updated recently</span>
